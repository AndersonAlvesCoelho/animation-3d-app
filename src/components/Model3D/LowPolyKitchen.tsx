...
export function ModelLowPolyKitchen(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF(require('../../assets/models/LowPolyKitchen.glb')) as GLTFResult
  return (
    <group {...props} dispose={null} scale={7} position={[0, -1, 1]}>
      <mesh
        castShadow
        receiveShadow
      ...
      <group position={[3.311, 3.529, -1.709]}>
        ...
        <mesh
          ...
          material={materials['Red jar']}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Cylinder014_3.geometry}
          material={materials['Green jar']}
        />
      </group>
      ...
      <group position={[3.25, 2.478, -2.264]}>
        ...
        <mesh
          ...
          material={materials['Milk cartoon']}
        />
      </group>
...
useGLTF.preload(require('../../assets/models/LowPolyKitchen.glb'))
